...
export default function WishesWall() {
  ...
  return (
    <section className="relative px-6 py-20">
      <SectionHeading eyebrow="Blessings" title="Wedding Wishes Wall" subtitle="ආශීර්වාද සහ සුභ පැතුම්" />
          ...
          <AnimatePresence initial={false}>
            {wishes.map((wish) => (
              <motion.li
                ...
                className="rounded-2xl border border-gold/25 bg-cream/70 px-5 py-4 shadow-sm"
              >
                <div className="flex items-center gap-2">
                  <Heart size={16} className="text-rose-gold" aria-hidden="true" />
